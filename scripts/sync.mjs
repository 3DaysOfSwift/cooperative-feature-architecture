...
export function sync(base = root) {
  ...
  for(const skill of ['cfa-app-creation', 'cfa-architecture-adoption', 'swift-concurrency-migration', 'cfa-architecture-review', 'cfa-codebase-tidy']) copy('LICENSE',`skills/${skill}/LICENSE`);
